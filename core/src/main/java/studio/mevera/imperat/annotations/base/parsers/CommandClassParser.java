            ...
            case JAVA -> new CommandElementParser<>(
                ...
                ElementSelector.<MethodElement>create()
                        ...
                        .addRule(MethodRules.HAS_KNOWN_SENDER
                                         .or(MethodRules.IS_PROCESSOR)
                                         .or(MethodRules.HAS_EXCEPTION_HANDLER_ANNOTATION))
    ...
    private static <S extends CommandSource> CommandClassParser<S, Set<Command<S>>> createKotlinVisitorReflectively(
        ...
        try {
            ...
            Class<?> factory = Class.forName(
                    "studio.mevera.imperat.annotations.base.parsers.KotlinCommandParsingVisitorFactory"
            );
