...
public interface Cursor<S extends Source> {
     ...
     */
    @Nullable
    Argument<S> currentParameterIfPresent();
     ...
     */
    @NotNull
    default Optional<Argument<S>> currentParameter() {
     ...
     */
    @Nullable
    Argument<S> peekParameterIfPresent();
     ...
     */
    @Nullable Argument<S> nextParameter();
     ...
     */
    @NotNull List<Argument<S>> getParametersList();
