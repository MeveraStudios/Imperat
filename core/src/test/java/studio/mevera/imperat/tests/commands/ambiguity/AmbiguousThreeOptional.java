 ...
 */
@RootCommand("ambiguous-three-optional")
public class AmbiguousThreeOptional {

    @Execute
    public void withFirst(TestCommandSource source, @Optional String first) {
        source.reply("First: " + first);
    }

    @Execute
    public void withSecond(TestCommandSource source, @Optional String second) {
        source.reply("Second: " + second);
    }

    @Execute
    public void withThird(TestCommandSource source, @Optional String third) {
